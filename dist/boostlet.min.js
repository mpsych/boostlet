...
class Util {
    ...
    static async load_script(url, callback) {
        ...
        script.src = url;
        if (typeof callback != "undefined") script.onload = callback;
   ...
   **/ static harden_mask(pixels11, mask11, maskcolor11) {
        ...
        // All rights reserved.
        console.log("p", pixels11);
        console.log("m", mask11);
        let maskcolor_11 = [
            0,
            114,
            189,
        ...
        if (typeof maskcolor11 != "undefined") maskcolor_11 = maskcolor11;
...
class $fbafa14c3ac31938$export$3d6843c2c4a1bd6c extends (0, $bsgU1.Framework) {
   ...
   **/ set_image(new_pixels, rgba, noflip) {
        ...
        if (typeof rgba == "undefined") new_pixels_rgba = (0, $gk9zP.Util).grayscale_to_rgba(new_pixels);
        else new_pixels_rgba = new_pixels;
    ...
    set_mask(new_mask) {
        ...
        let image_rgba = (0, $gk9zP.Util).grayscale_to_rgba(image.data);
        let masked_image = (0, $gk9zP.Util).harden_mask(image_rgba, new_mask);
