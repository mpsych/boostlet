...
class $24b0b601b3c03f0b$export$ec354fbcff0ba88d {
    constructor(){
        this.version = "1.0.0";
        this.categories = {};
    ...
    set category(categoryName) {
        if (!this.categories.hasOwnProperty(categoryName)) this.categories[categoryName] = [];
        this._currentCategory = categoryName;
    }
}
window.BOOSTLET = new $24b0b601b3c03f0b$export$ec354fbcff0ba88d(); // Single JavaScript file containing both HTML and JavaScript code
...
window.BOOSTLET = new (0, $24b0b601b3c03f0b$export$ec354fbcff0ba88d)();
